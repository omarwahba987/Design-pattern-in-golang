...
//the problem: Observer pattern is used when there is one-to-many relationship between objects
// such as if one object is modified, its depenedent objects are to be notified automatically.
// Observer pattern falls under behavioral pattern category.
//
//the solution: Observer pattern uses three actor classes. Subject,
