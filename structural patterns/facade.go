package main
// https://github.com/yksz/go-design-patterns/blob/master/structure/facade.go
// structural pattern
...
// in this ComputerFacade is collection of other methods allocated together for more simplisty
...
func NewComputerFacade() *ComputerFacade {
	var C CPU
	return &ComputerFacade{&C, new(Memory), new(HardDrive)}
}
